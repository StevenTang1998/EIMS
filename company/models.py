...
class Company(models.Model):
    ...
    registered_capital = models.CharField('注册资本', max_length=64)
    paid_up_capital = models.CharField('实缴资本', max_length=64)
    business_scope = models.CharField('经营范围', max_length=1024)
    industry = models.CharField('所属行业', max_length=128)
    tel = models.CharField('电话', max_length=64)
    email = models.EmailField('邮箱')
    province = models.CharField('省', max_length=32)
    city = models.CharField('市', max_length=32)
    district = models.CharField('县/区', max_length=32)
    detail_address = models.CharField('详细地址', max_length=128)
    company_type = models.CharField('企业类型', max_length=128)
    business_registration_number = models.CharField('工商注册号', max_length=14)
    registration_authority = models.CharField('登记机关', max_length=128)
    operating_status = models.CharField('经营范围', max_length=64)
...
class Change(models.Model):
    ...
    change_item = models.CharField('变更项目', max_length=64)
